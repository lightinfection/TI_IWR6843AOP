...
def generate_launch_description():
    return LaunchDescription([
        ...
        executable="pcl_pub",
        parameters=[
            {'cfg_path': str(get_package_share_path('ti_ros2_driver') / 'cfg/3d_tracking_indoor.cfg')},   # cfg file for ti mmwave, please refer to the /cfg/rules.txt for detail
            ...
            {'publish_target_tracker': True},                                                             # Optional, if publish the target tracker as compact pointclouds, only available for 3d_tracking binary mode
